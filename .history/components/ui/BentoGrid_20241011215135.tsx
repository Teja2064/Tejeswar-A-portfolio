...
export const BentoGridItem = ({
  ...
  const handleCopy=()=>{
    const text = "tejeswaryadav8@gmail.com"
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          " linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(12,14,135,1) 46%, rgba(12,14,35,1) 100%)",
      }}
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fitt absolute
            -right-3 lg:right-2">
                <div className="flex flex-col gap-3 lg:gap-8">
                    {["React.js","Redux.js","Next.js","TypeScript"].map
                    ((item)=>(
                ...
                <div className="flex flex-col gap-3 lg:gap-8">
                <span className="py-4 px-3 rounded-lg text-center bg-[#10132e]"/>
                    {["Vue.js","Angular.js","MongoDB","AWS"].map
                    ((item)=>(
                        <span key={item} className="py-2 lg:py-4 lg:px-3 px-3 text-xs 
                        lg:text-base opacity-50 lg:opacity-100 rounded-lg
                        text-center bg-[#10132E]">
